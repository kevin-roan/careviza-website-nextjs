...
const instagramPosts = [
  {
    id: 1,
    embedUrl:
      "https://www.instagram.com/p/DNSgKu7CeK6/?utm_source=ig_embed&amp;utm_campaign=loading",
    caption:
      "Celebrating our amazing nurses who make a difference every day! 💙 #NursingLife #CareViza",
    likes: 245,
    comments: 18,
    timeAgo: "2h",
  },
  ...
  },
  {
    ...
    embedUrl:
      "https://www.instagram.com/p/DNSgKu7CeK6/?utm_source=ig_embed&amp;utm_campaign=loading",
    caption:
      "Ready to advance your nursing career? We're here to help you find the perfect opportunity! #CareerGrowth",
    likes: 156,
    comments: 9,
    timeAgo: "2d",
  },
  {
    ...
    embedUrl:
      "https://www.instagram.com/p/DNSgKu7CeK6/?utm_source=ig_embed&amp;utm_campaign=loading",
    caption:
      "Teamwork makes the dream work! Join our network of healthcare professionals. #TeamWork #NursingJobs",
    likes: 203,
    comments: 15,
    timeAgo: "3d",
  },
              ...
              <Card className="overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-500 bg-white">
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed mb-2">
                    <span className="font-semibold">careviza</span>{" "}
                    {post.caption}
                  </p>
